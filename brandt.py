...
# print(y)
# x =4        
# #x is type of int concatenation 
# # putting strings together
# print("the x value is "+ str(x))  #Type casting
...
# name_Variables="" #variable name with two words first lowercase second Uppercase
...
x = "awesome"
print("Python is " + x)
#shift tab to move left and tab to move right
x = "Python is"
y = "awesome"
z =  x + y
print(z)
...
def Brandt():  #this is a function definition
    print("Python is " + x)
    print("Goodbye")
#is the end of the function

Brandt()    #is a function call
...
# print(type(b))
# print(type(c))
randVal=random.randrange(5, 10)

print(randVal)
randVal=random.getrandbits(3)
print(randVal)
